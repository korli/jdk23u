...
/**
 * Haiku implementation of UserDefinedFileAttributeView using extended attributes.
 */

class HaikuUserDefinedFileAttributeView
    extends AbstractUserDefinedFileAttributeView
{
    ...
    HaikuUserDefinedFileAttributeView(UnixPath file, boolean followLinks) {
        this.file = file;
